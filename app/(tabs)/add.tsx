...
const styles = StyleSheet.create({
  container: { flex: 1 },
  modeRow: { flexDirection: 'row', paddingHorizontal: 12, paddingVertical: 7, gap: 7 },
  ...
  templateSearchInput: { borderRadius: 9, paddingHorizontal: 12, paddingVertical: 7, fontSize: 13, borderWidth: 1, paddingRight: 34 },
  searchClear: { position: 'absolute', right: 20, top: 0, bottom: 0, justifyContent: 'center', paddingHorizontal: 8 },
  searchClearText: { fontSize: 15, fontWeight: '600' },
  categoryRow: { paddingHorizontal: 12, paddingVertical: 6, gap: 5 },
  ...
  manualContent: { padding: 14, paddingBottom: 28 },
